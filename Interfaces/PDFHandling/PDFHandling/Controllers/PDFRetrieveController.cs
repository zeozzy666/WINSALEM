...
namespace PDFHandling.Controllers
{
    public class PDFRetrieveController : ApiController
    {
        ...
        public String GetTrackingIDs(String fileName)
        {
            ...
            // https://localhost:44359/api/PDFRetrieve/GetTrackingIDs/toc010421.pdf/1
        }
        ...
        public HttpResponseMessage GetConfirmationDocument(String fileName, String trackingID)
        {
            ...
            Utilites.getUSPSDocument(fileName);
            HttpResponseMessage httpResponseMessage = Utilites.SplitPages(fileName, trackingID, Request, context.Response);
            ...
            //http://localhost:44359/api/PDFRetrieve/GetConfirmationDocument/pod0104210001.pdf/9171999991703876895656
