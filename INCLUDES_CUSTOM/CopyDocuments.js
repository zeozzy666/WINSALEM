...
/*===========================================
Title : copyDocuments
Purpose : copy documents from one record to another 
Author: Deanna Hoops		
Functional Area : documents
Description : Copies the documents associated with one record to another record
Reviewed By: DMH
Script Type : (EMSE, EB, Pageflow, Batch): EMSE
General Purpose/Client Specific : General
Client developed for : 
Parameters:
	pFromCapId - cap id object of record to copy from
	pToCapId - cap id object of record to copy to.
